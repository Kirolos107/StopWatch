...
/* Configure the MCU Pin direction, options are :
...
/* Configure the MCU Pin initial value in case of input direction, options are  :

 *							 													   1- FLOATING
 * 																				   2- PULLED_UP
 * Configure the MCU Pin initial value in case of output direction, options are :
